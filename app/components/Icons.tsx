...
export const Calendar = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="size-6 text-white transition-all"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const TrayekBus = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="size-6 inline-flex pb-1 mx-2"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const PlusMins = () => {
  return (
    <svg
      ...
      fill="red"
      stroke="currentColor"
      className="size-3 inline-flex stroke-orange-600"
    >
...
export const Route = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="size-8 inline-flex mx-2 p-1"
    >
...
export const Barier = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="size-24 inline-block mx-auto text-center"
    >
